"""runmfdndecomp02.py
    ...
    Example Lanczos decomposition runs using predefined decomposition types: L^2, S^2, Nex, and U3SpSnS.

    Ensure that the output of runmfdn13.py is in the current NCCI_LIBRARY_PATH.
