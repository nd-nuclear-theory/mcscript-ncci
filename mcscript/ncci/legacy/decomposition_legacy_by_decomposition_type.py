...
University of Notre Dame
    ...
    09/12/26 (mac): This is the legacy implementation of the decomposition
    operator, as defined via a set of predefined decomposition types, with fixed
    names taken from a registry (decomposition_operator_registry), each taking a
    fixed coefficient list.  Now reimplemented, alongside new decomp file
    format, as general linear combination of basis operators.
