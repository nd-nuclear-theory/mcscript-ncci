...
- 02/23/26 (mac): Add num_segments to task_descriptor_c1.
- 02/27/26 (mac): Add Nmax_orb to task_descriptor_c1.
...
def task_descriptor_c1(task):
    ...
    template_string = (
        ...
        "{sp_truncation:s}{mb_truncation:s}{mixed_parity_indicator}-Mj{M:03.1f}{Nmax_orb_indicator}{num_segments_indicator}"
    )
    ...
    if "Nmax_orb" in task["truncation_parameters"]:
        Nmax_orb_indicator = "-Nmax_orb{:02d}".format(task["truncation_parameters"]["Nmax_orb"])
    else:
        Nmax_orb_indicator = ""
    ...
    descriptor = template_string.format(
        ...
        mb_truncation=mb_truncation,
        mixed_parity_indicator=mixed_parity_indicator,
        Nmax_orb_indicator=Nmax_orb_indicator,
